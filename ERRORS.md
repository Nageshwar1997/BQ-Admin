...
C:\Users\nages\Desktop\BQ\BQ-Admin\src\pages\product\Products.tsx
  ...
  313:12  error  Unnecessary conditional, value is always truthy  @typescript-eslint/no-unnecessary-condition
  314:13  error  Unnecessary conditional, value is always truthy  @typescript-eslint/no-unnecessary-condition
  315:13  error  Unnecessary conditional, value is always truthy  @typescript-eslint/no-unnecessary-condition
  316:13  error  Unnecessary conditional, value is always truthy  @typescript-eslint/no-unnecessary-condition
  329:36  error  Unnecessary conditional, value is always falsy   @typescript-eslint/no-unnecessary-condition
...
C:\Users\nages\Desktop\BQ\BQ-Admin\src\pages\product\children\AddProductStockAndVariantsFields.tsx
   ...
   38:19  error  Unnecessary conditional, expected left-hand side of `??` operator to be possibly null or undefined         @typescript-eslint/no-unnecessary-condition
   85:42  error  Unnecessary optional chain on a non-nullish value                                                          @typescript-eslint/no-unnecessary-condition
  108:39  error  Invalid type "number" of template literal expression                                                       @typescript-eslint/restrict-template-expressions
  116:34  error  Unnecessary conditional, expected left-hand side of `??` operator to be possibly null or undefined         @typescript-eslint/no-unnecessary-condition
  119:57  error  Invalid type "number" of template literal expression                                                       @typescript-eslint/restrict-template-expressions
  131:39  error  Invalid type "number" of template literal expression                                                       @typescript-eslint/restrict-template-expressions
  147:39  error  Invalid type "number" of template literal expression                                                       @typescript-eslint/restrict-template-expressions
  169:63  error  Prefer using nullish coalescing operator (`??`) instead of a logical or (`||`), as it is a safer operator  @typescript-eslint/prefer-nullish-coalescing
  169:75  error  Unnecessary conditional, value is always truthy                                                            @typescript-eslint/no-unnecessary-condition
  185:55  error  Invalid type "number" of template literal expression                                                       @typescript-eslint/restrict-template-expressions
  200:35  error  Invalid type "number" of template literal expression                                                       @typescript-eslint/restrict-template-expressions
  219:37  error  Unnecessary optional chain on a non-nullish value                                                          @typescript-eslint/no-unnecessary-condition
  224:53  error  Invalid type "number" of template literal expression                                                       @typescript-eslint/restrict-template-expressions
  225:56  error  Invalid type "number" of template literal expression                                                       @typescript-eslint/restrict-template-expressions
  226:36  error  Unnecessary conditional, comparison is always true, since `"Add" === "Add"` is true                        @typescript-eslint/no-unnecessary-condition
  235:51  error  Unnecessary optional chain on a non-nullish value                                                          @typescript-eslint/no-unnecessary-condition

C:\Users\nages\Desktop\BQ\BQ-Admin\src\pages\product\children\AddProductTryOnConfigurationFields.tsx
  46:34  error  Prefer using nullish coalescing operator (`??`) instead of a logical or (`||`), as it is a safer operator  @typescript-eslint/prefer-nullish-coalescing
