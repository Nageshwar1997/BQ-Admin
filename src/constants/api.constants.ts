...
export const PRODUCT_STATUS_TRANSITIONS = {
  ...
  [PRODUCT_STATUS_MAP.PUBLISHED]: [PRODUCT_STATUS_MAP.BLOCKED, PRODUCT_STATUS_MAP.DELETED],

  [PRODUCT_STATUS_MAP.REJECTED]: [PRODUCT_STATUS_MAP.PENDING, PRODUCT_STATUS_MAP.BLOCKED],

  [PRODUCT_STATUS_MAP.BLOCKED]: [
    PRODUCT_STATUS_MAP.PENDING,
    PRODUCT_STATUS_MAP.PUBLISHED,
    PRODUCT_STATUS_MAP.DELETED,
  ],
